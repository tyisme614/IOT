...
<div class="row-fluid">
    ...
    <section class="span6">
        ...
        <article class="m-widget">
            <header class="header">
                <h4 class="title">修改</h4>
            </header>

            <div class="content content-inner">

                <form id="serviceForm" name="f" method="post" action="service-info-save.do" class="form-horizontal">
                    <input type="hidden" name="id" value="${model.id}">
                    <div class="control-group">
                        <label class="control-label" for="name">服务名</label>
                        <div class="controls">
                            <input type='text' id="name" name='name'  value="${model.name}" size="40" class="text required" minlength="2" maxlength="50">
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type='text' id="url" name='url'  value="${model.url}" size="40" class="text required" minlength="2" maxlength="200">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="desc">说明</label>
                        <div class="controls">
                            <textarea id="desc" name="desc" class="form-control" rows="3" >${model.desc}
                            </textarea>
                        </div>
                    </div>
