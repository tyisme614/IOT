    ...
    <section id="m-main" class="span10">
        ...
        <article class="m-widget">
            ...
            <div id="service-infoSearch" class="content content-inner">
                ...
                <form name="service-infoForm" method="post" action="my-pipe-file-info-list.do" class="form-inline">
        ...
        <article class="m-blank">
            <div class="pull-left">
                <button class="btn btn-small a-remove" onclick="javascript:window.location='${ctx}/content/pipe/file/pipe-file-info-add.jsp'">新增</button>
        ...
        <article class="m-widget">
            ...
            <div class="content">
                <form id="service-infoGridForm" name="service-infoGridForm" method='post' action="pipe-file-remove.do" class="m-form-blank">
                    <table id="service-infoGrid" class="m-table table-hover">
                        ...
                        <c:forEach items="${page.result}" var="item">
                            <tr>
                                ...
                                <td><a href="pipe-file-info-edit.do?sid=${item.id}" class="btn btn-small btn-primary">修改</a> </td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
