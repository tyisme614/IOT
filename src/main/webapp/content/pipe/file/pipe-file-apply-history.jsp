    ...
    <section id="m-main" class="span10">
        ...
        <article class="m-widget">
            ...
            <div id="service-infoSearch" class="content content-inner">
                ...
                <form name="service-infoForm" method="post" action="pipe-file-apply-history.do" class="form-inline">
        ...
        <article class="m-widget">
            <header class="header">
                <h4 class="title">我申请过的业务文件</h4>
            </header>
            <div class="content">
                    <table id="service-infoGrid" class="m-table table-hover">
                        <thead>
                        <tr>
                            <th class="sorting" name="pipeBizFileInfo.fileName">文件名称</th>
                            <th width="100" class="sorting" name="pipeBizFileInfo.pipeType">文件类型</th>
                            <th width="100" class="sorting" name="pipeBizFileInfo.fileSize">文件大小</th>
                            <th width="90" class="sorting" name="pipeBizFileInfo.uploader">上传人</th>
                            <th width="100" class="sorting" name="pipeBizFileInfo.uploadTime">上传时间</th>
