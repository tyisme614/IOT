...
<head>
    ...
    <script type="text/javascript">
        var config = {
            ...
            asc: ${page.asc},
            params: {
                'filter_LIKES_pipeBizFileInfo.fileName': '${param.filter_LIKES_pipeBizFileInfo.fileName}'
            },
    ...
    <section id="m-main" class="span10">
        ...
        <article class="m-widget">
            ...
            <div id="service-infoSearch" class="content content-inner">
                ...
                <form name="pipe-relate-resourceForm" method="post" action="pipe-file-apply-list.do" class="form-inline">
                    <label for="service-info_name">名称:</label>
                    <input type="text" id="service-info_name" name="filter_LIKES_pipeBizFileInfo.fileName" value="${param.filter_LIKES_pipeBizFileInfo.fileName}">
        ...
        <article class="m-widget">
            <header class="header">
                <h4 class="title">待审核管线业务文件下载申请列表</h4>
            </header>
            <div class="content">
                    <table id="pipe-relate-resourceGrid" class="m-table table-hover">
                        <thead>
                        <tr>
                            <th class="sorting" name="pipeBizFileInfo.fileName">资源名称</th>
                            <th class="sorting" name="pipeBizFileInfo.pipeType">资源类型</th>
                            <th class="sorting" name="pipeBizFileInfo.fileSize">资源大小</th>
                        ...
                        <c:forEach items="${page.result}" var="item">
                            <tr>
                                ...
                                <td>
                                    <a href="pipe-file-verify.do?id=${item.id}" class="btn btn-small btn-primary">通过</a>
                                    <a href="pipe-file-withdraw.do?id=${item.id}" class="btn btn-small btn-primary">撤销</a>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
