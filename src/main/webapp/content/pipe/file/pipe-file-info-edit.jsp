...
<div class="row-fluid">
    ...
    <section class="span6">
        ...
        <article class="m-widget">
            <header class="header">
                <h4 class="title">管线业务文件编辑</h4>
            </header>

            <div class="content content-inner">

                <form id="serviceForm" name="f" method="post" enctype="multipart/form-data" action="${ctx}/pipe/file/pipe-file-info-add.do" class="form-horizontal">
                    <input type="hidden" name="id" value="${model.id}">
                    <div class="control-group">
                        <label class="control-label" for="access_perm">业务类型</label>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        <label class="control-label" for="resourceFile">业务文件</label>
                        <div class="controls">
                            <input type="file" id="resourceFile" name='file'/>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="desc">业务说明</label>
                        <div class="controls">
                            <textarea id="desc" name="desc" class="form-control" rows="10">${model.desc}</textarea>
                        </div>
                    </div>
                    <div class="control-group">
                        <div class="controls">
